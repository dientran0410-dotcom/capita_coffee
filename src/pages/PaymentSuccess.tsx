...
const PaymentSuccess = () => {
    ...
    const resolveCustomerId = (inv: Invoice): string | null => {
        ...
        const candidates = [
            ...
            storedUser?.raw?.user?.id,
            storedUser?.raw?.data?.userId,
        ];
    ...
    useEffect(() => {
        ...
        (async () => {
            ...
            // Normalize payment method: treat any QR or momo variants as MOMO, cash/cod as CASH
            const normalizedPaymentMethod = (() => {
                const pm = paymentMethod;
                if (!pm) return null;
                if (pm.includes("MOMO") || pm.includes("QR")) return "MOMO";
                if (pm.includes("CASH") || pm.includes("COD")) return "CASH";
                return pm;
            })();
            ...
            try {
                ...
                const shouldCreateOrder = normalizedPaymentMethod === "MOMO" || normalizedPaymentMethod === "CASH";
